...
Supabase (supabase.com) — backend authentication, database, and real-time synchronization
AIDA International (aidainternational.org) — official source of competition data
